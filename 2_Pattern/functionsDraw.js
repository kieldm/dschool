...
function drawBase(index, counterOn){
  push();
    translate(-118, -96);

    if(baseIndexSet[index] == 0){
      beginShape();
        vertex(283.1,118.6);
        vertex(283.1,250.3);
